...
@Component({
  ...
  standalone: true,
  imports: [ CommonModule,ToastModule, ProgressSpinnerModule, MenuModule, SplitterModule, PanelModule, DataViewModule,DividerModule, ButtonModule, BadgeModule, TooltipModule, TagModule, ToolbarModule, TableModule, InputTextModule, FormsModule, FileUploadModule],
